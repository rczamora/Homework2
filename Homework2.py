...
df_stk = pd.read_csv("\\\\uem.walton.uark.edu\\UEMProfiles_Lab$\\rczamora\\RedirectedFolders\\Documents\\Finn510\\TGT1.csv",index_col='Date',parse_dates=True,index_col='Date',parse_dates=True)
df_stk.head()

# %%
stkName = 'TSLA'
fileName = 'stk2_' + stkName + '.csv'
readFile = fullDir+fileName 

df_stk2 = pd.read_csv("\\\\uem.walton.uark.edu\\UEMProfiles_Lab$\\rczamora\\RedirectedFolders\\Documents\\Finn510\\TSLA1.csv",index_col='Date',parse_dates=True,index_col='Date',parse_dates=True)
df_stk.head()

# %%
stkName = 'WMT'
fileName = 'stk3_' + stkName + '.csv'
readFile = fullDir+fileName 

df_stk3 = pd.read_csv("\\\\uem.walton.uark.edu\\UEMProfiles_Lab$\\rczamora\\RedirectedFolders\\Documents\\Finn510\\WMT1.csv",index_col='Date',parse_dates=True,index_col='Date',parse_dates=True)
df_stk.head()

# %%
stkName = 'LULU'
fileName = 'stk4_' + stkName + '.csv'
readFile = fullDir+fileName 

df_stk4 = pd.read_csv("\\\\uem.walton.uark.edu\\UEMProfiles_Lab$\\rczamora\\RedirectedFolders\\Documents\\Finn510\\LULU1.csv",index_col='Date',parse_dates=True,index_col='Date',parse_dates=True)
df_stk.head()

# %%
stkName = 'AMZN'
fileName = 'stk5_' + stkName + '.csv'
readFile = fullDir+fileName 

df_stk5 = pd.read_csv("\\\\uem.walton.uark.edu\\UEMProfiles_Lab$\\rczamora\\RedirectedFolders\\Documents\\Finn510\\AMZN1.csv",index_col='Date',parse_dates=True,index_col='Date',parse_dates=True)
df_stk.head()
